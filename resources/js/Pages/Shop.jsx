    ...
    return (
        <AppLayout currentPath="/shop">
            ...
            <section className="relative py-16 sm:py-20 lg:h-[400px] lg:py-0 flex items-center justify-center bg-gradient-to-b from-[#f2b7a7] to-[#9fcfc5] overflow-hidden px-6">
                ...
                {/* Left Peeking Cat */}
                <div className="absolute -left-10 md:left-0 bottom-0 w-[250px] md:w-[350px] pointer-events-none z-10 transition-transform duration-500 hover:scale-105">
                    <img 
                ...
                {/* Right Peeking Cat */}
                <div className="absolute -right-10 md:right-0 bottom-0 w-[250px] md:w-[350px] pointer-events-none z-10 transition-transform duration-500 hover:scale-105">
                    <img 
                ...
                <div className="relative z-20 text-center max-w-3xl">
                    <h1 className="text-5xl md:text-[64px] font-bold text-gray-900 mb-6">Shop</h1>
                    <p className="text-base md:text-[18px] text-gray-700 font-medium leading-relaxed mb-8">
                    ...
                    <button className="group relative overflow-hidden bg-gradient-to-r from-[#fac2ac] to-[#8bcbbd] hover:to-[#fac2ac] transition-all duration-500 rounded-2xl md:rounded-[24px] w-full max-w-[400px] py-4 shadow-lg">
                        <span className="relative z-10 text-lg md:text-xl font-bold text-gray-800 tracking-wide">
                            Click Merchandise
                        </span>
